...
You can easily run `tap-shopify-partner` by itself or in a pipeline using [Meltano](https://meltano.com/).
...
```bash
# Test invocation:
meltano invoke tap-shopify-partner --version
# OR run a test `elt` pipeline:
meltano elt tap-shopify-partner target-jsonl
```
